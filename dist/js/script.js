...
//Image Reveal Animation
	...
	window.addEventListener("DOMContentLoaded", (event) => {
		...
		if (document.querySelectorAll(".text-split").length > 0) {
		...
		if ($(".words-slide-from-right").length > 0) {
		...
		if ($(".letters-slide-down").length > 0) {
		...
		if ($(".letters-fade-in-random").length > 0) {
