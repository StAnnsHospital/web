    ...
    <section class="page-title" style="background-image: url(/images/background/8.jpg);">
      <div class="auto-container">
        <div class="title-outer">
          <h1>Blog Post Quote</h1>
          <ul class="page-breadcrumb">
            <li><router-link to="/">Home</router-link></li>
            <li>Blog Post Quote</li>
          </ul> 
        </div>
      </div>
    </section>
                ...
                <div class="inner-box">
                  <div class="image">
                    <blockquote class="post-format-quote">
                      ...
                      Over the river and through the woods was more dangerous back when cars had crummy bias-ply tires, rear-wheel drive. Kevin tail capicola bresaola, prosciutto swine cupim tri-tip boudin shoulder frankfurter.
                      <cite>Tommy Willson</cite>
                    </blockquote>
                  </div>
